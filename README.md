...
color = 0x00FFFF
```
`Bot/config/logging.py` ([Logging Config FAQ](https://github.com/AnriaruDoragon/discord-py-Bot-Sample/blob/dfe73af9f0b2d089ea89d18f39c997b5568cb02c/Bot/Logs/README.md))
```py
# Logging to the file
log_enable = True
